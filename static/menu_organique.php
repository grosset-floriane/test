    <a href="index.php?r=cellules"><img class="icones"src="" alt="Cellules de mort"></a>
    ...
    <a href="index.php?r=phaeophyceae"><img class="icones"src="" alt="Phaeophyceae"></a>
    ...
    <a href="index.php?r=un_autre"><img class="icones"src="" alt="L'un dans l'autre"></a>
